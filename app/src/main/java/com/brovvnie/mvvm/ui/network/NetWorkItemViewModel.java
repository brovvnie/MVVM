...
import com.brovvnie.mvvm.base.ItemViewModel;
...
import com.brovvnie.mvvm.ui.network.detail.DetailFragment;
...
public class NetWorkItemViewModel extends ItemViewModel<NetWorkViewModel> {
    ...
    public NetWorkItemViewModel(@NonNull NetWorkViewModel viewModel, DemoEntity.ItemsEntity entity) {
        ...
        drawableImg = ContextCompat.getDrawable(Utils.getApp(), R.mipmap.ic_launcher);
    }
